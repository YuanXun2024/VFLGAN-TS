...
parser.add_argument('--loo', type=int, default=809) # 911: proposed method; 808: proposed v4; 737: Record 1 (groundhog day); 913: Record 2.  223: proposed v5
parser.add_argument('--dataset', type=str, default='EEG_Eye_State_ZeroOne_chop_5best_0')
parser.add_argument('--nepochs', type=int, default=151)
...
parser.add_argument('--glr', type=float, default=0.0006)
parser.add_argument('--dlr', type=float, default=0.0006)
        ...
        if epoch % 10 == 0:
            ...
            for f in range(n_groups):
                for t in range(n_samples):
                    ...
                    input_1 = generated_samples[:, n_samples*f+t]
