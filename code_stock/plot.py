...
wd_path_SD = 'params_vfl/stock_data_24/with_SD/wd_all_vfl.npy'
wd_path_woSD = 'params_vfl/stock_data_24/without_SD/wd_all_vfl.npy'
wd_path_coscigan = 'params_coscigan/stock_data_24/wd_all_vfl.npy'
wd_path_vflgan = '../vflgan_stock/params/stock_data_24/wd_all_vfl.npy'
