...
wd_path_SD = 'params_vfl/energy_data_24/with_SD/wd_all_vfl.npy'
wd_path_woSD = 'params_vfl/energy_data_24/without_SD/wd_all_vfl.npy'
wd_path_coscigan = 'params_coscigan/energy_data_24/wd_all_vfl.npy'
