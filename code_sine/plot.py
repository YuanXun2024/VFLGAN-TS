...
wd_path_SD = 'params_vfl/data_frame_sine_normal/with_SD/wd_average.npy'
wd_path_woSD = 'params_vfl/data_frame_sine_normal/without_SD/wd_average.npy'
wd_path_coscigan = 'params_coscigan/data_frame_sine_normal/with_CD/wd_average.npy'
