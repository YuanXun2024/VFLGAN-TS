...
folder_withSD = 'params_vfl/data_frame_sine_normal/with_SD/'
folder_withoutSD = 'params_vfl/data_frame_sine_normal/without_SD/'
folder_coscigan= 'params_coscigan/data_frame_sine_normal/with_CD/'
...
for i in range(n_groups_1):
    ...
    params_path = f'params_vfl/data_frame_sine_normal/with_SD/Generator_0_epoch_{epoch}.pt'
...
for i in range(n_groups_2):
    ...
    params_path = f'params_vfl/data_frame_sine_normal/with_SD/Generator_1_epoch_{epoch}.pt'
...
for i in range(n_groups_1):
    generator_1[i] = LSTMGenerator(latent_dim=noise_len, ts_dim=n_samples).to(device)
    params_path = f'params_vfl/data_frame_sine_normal/without_SD/Generator_0_epoch_{epoch}.pt'
    generator_1[i].load_state_dict(torch.load(params_path))
    generator_1[i].eval()

for i in range(n_groups_2):
    generator_2[i] = LSTMGenerator(latent_dim=noise_len, ts_dim=n_samples).to(device)
    params_path = f'params_vfl/data_frame_sine_normal/without_SD/Generator_1_epoch_{epoch}.pt'
    generator_2[i].load_state_dict(torch.load(params_path))
    generator_2[i].eval()
...
for i in range(n_groups):
    ...
    params_path = f'params_coscigan/data_frame_sine_normal/with_CD/Generator_0_epoch_{epoch}.pt'
